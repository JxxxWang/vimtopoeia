...
def main(h5_path: str, checkpoints_dir: str, ast_model_path: str):
    """
    Train the Vimtopoeia model without spectral convolution augmentation.
    ...
    print("Training without spectral convolution augmentation")
    ...
    plt.title('Vimtopoeia Training & Validation Loss (No Spectral Convolution)')
    plt.xlabel('Epochs')
    plt.ylabel('MSE Loss')
    plt.grid(True)
    plt.legend()
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Train Vimtopoeia model without spectral convolution')
